...
class CustomVariables(BaseModel):
    ...
    MainCase_gps_antenna_housing_hole_width: float = Field(26, title='square side length in mm', ge=22, le=30)
    MountRail_clearance: float = Field(0.2, title="clearance for mounting rail in mm", ge=0, le=1)
    ...
    DisplayCase_outer_width: float = Field(30.0, title='in mm', ge=28, le=34)
    DisplayCaseTop_window_width: float = Field(21.5, title='in mm', ge=20, le=24)
    DisplayCaseTop_window_height: float = Field(12.5, title='in mm', ge=10, le=15)
    DisplayCaseTop_window_offset: float = Field(2, title='in mm from bottom', ge=0, le=5)
