...
module DisplayCaseTop() {
  ...
  standoff_width = (DisplayCaseTop_large_pcb_width-DisplayCaseTop_cable_clearance)/2;
  ...
  union () {
    difference() {
      ...
      // hole for PCB
      translate(DisplayCaseTop_large_pcb_origin) {
        cube([DisplayCaseTop_large_pcb_width, DisplayCaseTop_large_pcb_height, pcb_depth*2], center=true);
      }
      ...
      translate([-DisplayCase_outer_width+DisplayCase_outer_large_radius, -45, 0]) {
        difference() {
          union () {
            ...
            translate([0, 0, -pcb_depth+DisplayCaseTop_pcb_standoff+DisplayCaseTop_large_pcb_origin.z])
      ...
      translate(DisplayCaseTop_large_pcb_origin - [0, DisplayCaseTop_large_pcb_height / 2-epsilon,pcb_depth-DisplayCaseTop_pcb_standoff]) linear_extrude(4)
        polygon(polyRound([
            [-10.5,0,0],
            [-8.5, 0, 2],
            [-8.5, -6, 0],
    ...
    mirrorCopy([0, 1, 0])
    mirrorCopy([1, 0, 0])
    translate([-DisplayCaseTop_large_pcb_width/2, -DisplayCaseTop_large_pcb_height/2, -pcb_depth])
